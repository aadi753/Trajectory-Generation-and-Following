...
bool Scurve::calcCoeffs ( std::vector<double>initPos , std::vector<double>targetPos , double maxVel , double maxAcc , double maxJerk , bool degrees , std::vector<double>initVel , std::vector<double>finalVel ) {
