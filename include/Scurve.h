...
*@brief a trajectory generation class for smooth trajectories using S-curves
*@version 0.1
* @date 2024 - 02 - 02
*
*/
...
class Scurve  {
     ...
     double hardVelLimit_ {90}, hardAccLimit_{90} , hardJerkLimit_{90};

     std::vector<std::vector<double>> finalCoeffMat_;
     std::vector<std::vector<double>> pathMat_;
     ...
     /**
         ...
         * @return false
         */
     int calcCoeffs ( std::vector<double> initPos , std::vector<double> targetPos ,
          double maxVel , double maxAcc , double maxJerk ,
          bool degrees = true , std::vector<double> initVel = { 0 } ,
          std::vector<double> finalVel = { 0 } ,
          std::vector<double> initAccel = {} ,
          std::vector<double> finalAccel = {} ,
          std::vector<double> initJerk = {} ,
